program nearest_surface_benchmark
    ...
    call shape%export_Xc("vtk/nearest_surface_benchmark_Xc.vtk")
    call shape%export_Xg("vtk/nearest_surface_benchmark_Xg.vtk")
    call shape%export_Xth_in_Xg("vtk/nearest_surface_benchmark_Xth.vtk")
    call shape%show("vtk/nearest_surface_benchmark_Xc.vtk", "vtk/nearest_surface_benchmark_Xg.vtk", "vtk/nearest_surface_benchmark_Xth.vtk")
...
end program nearest_surface_benchmark
