...
program volume_plate_hole_half
   ...
   call plate_hole%export_Xc("vtk/volume_plate_hole_half_Xc.vtk")
   call plate_hole%export_Xg("vtk/volume_plate_hole_half_Xg.vtk")
   call plate_hole%export_Xth_in_Xg("vtk/volume_plate_hole_half_Xth.vtk")

   call plate_hole%show("vtk/volume_plate_hole_half_Xc.vtk", "vtk/volume_plate_hole_half_Xg.vtk", "vtk/volume_plate_hole_half_Xth.vtk")
...
contains
   ...
   !===============================================================================
end program volume_plate_hole_half
