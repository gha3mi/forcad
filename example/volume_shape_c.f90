...
program volume_shape_c
    ...
    call shape%export_Xc("vtk/volume_shape_c_Xc.vtk")
    ...
    call shape%export_Xg("vtk/volume_shape_c_Xg.vtk")
    ...
    call shape%export_Xth_in_Xg("vtk/volume_shape_c_Xth.vtk")
    call shape%show("vtk/volume_shape_c_Xc.vtk", "vtk/volume_shape_c_Xg.vtk", "vtk/volume_shape_c_Xth.vtk")
