...
program surface_plate_hole_full
   ...
   call plate_hole%export_Xc("vtk/surface_plate_hole_full_Xc.vtk")
   call plate_hole%export_Xg("vtk/surface_plate_hole_full_Xg.vtk")
   call plate_hole%export_Xth_in_Xg("vtk/surface_plate_hole_full_Xth.vtk")

   call plate_hole%show("vtk/surface_plate_hole_full_Xc.vtk", "vtk/surface_plate_hole_full_Xg.vtk", "vtk/surface_plate_hole_full_Xth.vtk")
...
contains
   ...
   !===============================================================================
end program surface_plate_hole_full
