...
program volume_pipe_toroidal
   ...
   call sh%export_Xc("vtk/volume_pipe_toroidal_Xc.vtk")
   call sh%export_Xg("vtk/volume_pipe_toroidal_Xg.vtk")
   call sh%export_Xth_in_Xg("vtk/volume_pipe_toroidal_Xth.vtk", res=24)

   ! Show the resulting VTK files
   call sh%show("vtk/volume_pipe_toroidal_Xc.vtk", "vtk/volume_pipe_toroidal_Xg.vtk", "vtk/volume_pipe_toroidal_Xth.vtk")
...
contains
   ...
   !===============================================================================
end program volume_pipe_toroidal
