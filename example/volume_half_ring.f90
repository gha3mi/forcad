...
program volume_half_ring
    ...
    call shape%export_Xc("vtk/volume_half_ring_Xc.vtk")
    ...
    call shape%export_Xg("vtk/volume_half_ring_Xg.vtk")
    ...
    call shape%export_Xth_in_Xg("vtk/volume_half_ring_Xth.vtk")
    call shape%show("vtk/volume_half_ring_Xc.vtk", "vtk/volume_half_ring_Xg.vtk", "vtk/volume_half_ring_Xth.vtk")

    !> Finalize and clean up the shape object.
    call shape%finalize()

end program volume_half_ring
