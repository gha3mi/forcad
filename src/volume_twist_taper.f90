...
program volume_twist_taper
   ...
   call build_volume_twist_taper(sh, L, nc, twist_deg, taper)

   ! Create the NURBS volume sampling
   call sh%create(30,30,80)

   ! Export the NURBS volume to VTK files
   call sh%export_Xc("vtk/volume_twist_taper_Xc.vtk")
   call sh%export_Xg("vtk/volume_twist_taper_Xg.vtk")
   call sh%export_Xth_in_Xg("vtk/volume_twist_taper_Xth.vtk", res=30)

   ! Show the NURBS volume
   call sh%show("vtk/volume_twist_taper_Xc.vtk", "vtk/volume_twist_taper_Xg.vtk", "vtk/volume_twist_taper_Xth.vtk")
...
contains
   ...
   pure subroutine build_volume_twist_taper(this, L, nc, twist_deg, taper)
   ...
   !===============================================================================
end program volume_twist_taper
