...
program surface_shape_c
    ...
    call shape%export_Xc("vtk/surface_shape_c_Xc.vtk")
    ...
    call shape%export_Xg("vtk/surface_shape_c_Xg.vtk")
    ...
    call shape%export_Xth_in_Xg("vtk/surface_shape_c_Xth.vtk")
    call shape%show("vtk/surface_shape_c_Xc.vtk", "vtk/surface_shape_c_Xg.vtk", "vtk/surface_shape_c_Xth.vtk")
