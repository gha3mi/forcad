...
program surface_nearest
    ...
    call shape%export_Xc("vtk/surface_nearest_Xc.vtk")
    call shape%export_Xg("vtk/surface_nearest_Xg.vtk")
    call shape%export_Xth_in_Xg("vtk/surface_nearest_Xth.vtk")
    call shape%show("vtk/surface_nearest_Xc.vtk", "vtk/surface_nearest_Xg.vtk", "vtk/surface_nearest_Xth.vtk")
    ...
    write(*,"(a,1x,g0,2x,g0,2x,g0,a,2x,g0,2x,g0,2x,a,1x,g0)") &
    ...
    write(*,"(a,1x,g0,2x,g0,2x,g0,a,2x,g0,2x,g0)") &
