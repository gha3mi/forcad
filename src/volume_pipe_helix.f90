...
program volume_pipe_helix
   ...
   call sh%export_Xc("vtk/volume_pipe_helix_Xc.vtk")
   call sh%export_Xg("vtk/volume_pipe_helix_Xg.vtk")
   call sh%export_Xth_in_Xg("vtk/volume_pipe_helix_Xth.vtk", res=20)

   ! Show the NURBS volume
   call sh%show("vtk/volume_pipe_helix_Xc.vtk", "vtk/volume_pipe_helix_Xg.vtk", "vtk/volume_pipe_helix_Xth.vtk")
