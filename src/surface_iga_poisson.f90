...
program surface_iga_poisson
   ...
   filename = "vtk/surface_iga_poisson"
   ...
   write(*,'(a,g0,",",g0)') "Degree (dir1, dir2)                  : ", surf%get_degree(1), surf%get_degree(2)
   write(*,'(a,g0,"x",g0)') "Control net size (dir1 x dir2)       : ", nc(1), nc(2)
   write(*,"(a,g0)") "Total control points                 : ", nct
   write(*,"(a,g0)") "Number of elements                   : ", nelem
   write(*,"(a,g0)") "Degrees of freedom (DoFs)            : ", ndof
   write(*,'(a,g0," x ",g0)') "Domain size (L1, L2)                 : ", L(1), L(2)
   write(*,'(a,g0,",",g0)') "Mode numbers (m1, m2)                : ", m(1), m(2)
   write(*,'(a,g0,",",g0)') "Knot insertion (dir1, dir2)          : ", ki(1), ki(2)
   write(*,'(a,g0,"x",g0)') "Visualization resolution (res1, res2): ", res(1), res(2)
   ...
   call surf%export_Xth_in_Xg(trim(filename)//"_Xth.vtk", res=maxval(res))
   call surf%show(trim(filename)//".vtk", trim(filename)//"_interp.vtk", trim(filename)//"_Xth.vtk")
...
end program surface_iga_poisson
