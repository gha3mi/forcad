...
program surface_tetragon
    ...
    call shape%export_Xc("vtk/surface_tetragon_Xc.vtk")
    ...
    call shape%export_Xg("vtk/surface_tetragon_Xg.vtk")
    ...
    call shape%export_Xth_in_Xg("vtk/surface_tetragon_Xth.vtk")
    call shape%show("vtk/surface_tetragon_Xc.vtk", "vtk/surface_tetragon_Xg.vtk", "vtk/surface_tetragon_Xth.vtk")
