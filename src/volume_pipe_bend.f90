...
program volume_pipe_bend
   ...
   call build_pipe_bend(sh, c, l, rb, a(1))

   ! Create the NURBS volume
   call sh%create(30,40,80)

   ! Export the NURBS volume to VTK files
   call sh%export_Xc("vtk/volume_pipe_bend_90_Xc.vtk")
   call sh%export_Xg("vtk/volume_pipe_bend_90_Xg.vtk")
   call sh%export_Xth_in_Xg("vtk/volume_pipe_bend_90_Xth.vtk")

   ! Show the NURBS volume
   call sh%show("vtk/volume_pipe_bend_90_Xc.vtk", "vtk/volume_pipe_bend_90_Xg.vtk", "vtk/volume_pipe_bend_90_Xth.vtk")
   ...
   ! Build the bend pipe shape
   call build_pipe_bend(sh, c, l, rb, a(2))

   ! Create the NURBS volume
   call sh%create(30,40,80)

   ! Export the NURBS volume to VTK files
   call sh%export_Xc("vtk/volume_pipe_bend_270_Xc.vtk")
   call sh%export_Xg("vtk/volume_pipe_bend_270_Xg.vtk")
   call sh%export_Xth_in_Xg("vtk/volume_pipe_bend_270_Xth.vtk")

   ! Show the NURBS volume
   call sh%show("vtk/volume_pipe_bend_270_Xc.vtk", "vtk/volume_pipe_bend_270_Xg.vtk", "vtk/volume_pipe_bend_270_Xth.vtk")
   ...
   ! Build the bend pipe shape
   call build_pipe_bend(sh, c, l, rb, a(3))

   ! Create the NURBS volume
   call sh%create(30,40,80)

   ! Export the NURBS volume to VTK files
   call sh%export_Xc("vtk/volume_pipe_bend_360_Xc.vtk")
   call sh%export_Xg("vtk/volume_pipe_bend_360_Xg.vtk")
   call sh%export_Xth_in_Xg("vtk/volume_pipe_bend_360_Xth.vtk")

   ! Show the NURBS volume
   call sh%show("vtk/volume_pipe_bend_360_Xc.vtk", "vtk/volume_pipe_bend_360_Xg.vtk", "vtk/volume_pipe_bend_360_Xth.vtk")
...
contains
   ...
   pure subroutine build_pipe_bend(this, center, length, rbend, angle_deg)
